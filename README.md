# Lab: Find the Largest Value (Register-Indirect Addressing)

## Goal

Write a tiny **x86-64 Linux** assembly program that **finds the largest 64-bit integer in an array** using **register-indirect addressing** (i.e., load the array’s *address* into a register and access elements via `(%reg)` as you walk through memory).
